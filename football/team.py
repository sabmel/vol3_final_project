...
class Team():
    ...
    def play_drive(self):
        ...
        Returns:
            ...
            - time spent (float): seconds spent in possession of the ball
        """
        # pull play yardage and play time from the GaussianHMM
